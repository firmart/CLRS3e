...
Supposons qu'on travaille sur des entiers, alors les procédures suivantes sont $O(1)$ en temps. La procédure \proc{Bit-Vector-Search} retourne \const{true} si le bit $k$ vaut $1$ et $\const{false}$ réciproquement.
